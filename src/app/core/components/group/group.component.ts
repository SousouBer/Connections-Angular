...
export class GroupComponent implements OnInit {
  ...
  constructor(private authService: AuthService, private dataStorageService: DataStorageService, private store: Store<AppState>) {}
  ...
  removeGroup(){
    ...
    this.dataStorageService.deleteGroup(groupid).subscribe(
      val => this.store.dispatch(removeGroup({ groupID: groupid }))
    )
  }
}
